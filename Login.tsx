    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Sign in to your account to continue reading</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="p-3">
            ...
            <p className="text-xs text-gray-600">Read PDFs</p>
          </div>
          <div className="p-3">
            <div className="h-6 w-6 bg-gradient-to-r from-purple-500 to-blue-500 rounded mx-auto mb-2 flex items-center justify-center">
